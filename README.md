...
![序章截图](docs/screenshots/01-prologue.png)

**第一关 · 血条反相关**——脚下踩的其实是伤害砖（画面把它伪装成 ❤），扣血之后血条却"涨"了。
![第一关截图](docs/screenshots/02-level1-invert-bar.png)

**第四关 · 伪 OS 假报错**——满屏"致命错误"，醒目的【確定】按多少次都关不掉，真正的出口藏在错误堆栈里一行不起眼的文字上。
![第四关截图](docs/screenshots/03-level4-fake-os.png)

**真结局**——界面终于不装了，从满屏杀马特故障态收束成一张干净的可分享战绩卡。
![真结局截图](docs/screenshots/04-ending.png)
